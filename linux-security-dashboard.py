...
LANGS = {
    ...
    "ES": {
        "title":"PANEL DE SEGURIDAD LINUX v4.2",
    ...
    "FR": {
        "title":"TABLEAU DE BORD SÉCURITÉ LINUX v4.2",
...
class StartupWizard(QDialog):
    ...
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("Welcome to Linux Security Dashboard")
    ...
    def _build_pages(self):
        ...
        # ── Page 1: Welcome ──
        p1, l1 = self._page_wrapper("⬡  LINUX SECURITY DASHBOARD v4.2")
        intro = QLabel(
...
class AuditDashboard(QMainWindow):
    ...
    def __init__(self, wizard_result=None):
        super().__init__()
        self.setWindowTitle("Linux Security Dashboard v4.2")
